    ...
    <div id="app" :style="{backgroundImage:'url('+host+skin.bgImg+')'}">
      ...
      <el-button type="primary" @click="avatarConfirm">保存</el-button>
        ...
        <header>
            ...
            <span class="el-dropdown-link" :style="{color:skin.color}">{{userInfo.XM}}
              <i class="el-icon-caret-bottom el-icon--right"></i>
                    ...
                    <button class="btn123" :style="{color:skin.color,borderColor:skin.color}" @click="zhuxiao">注销
                    </button>
                </div>
            </div>
        </header>
        ...
        <skin v-on:colorToAll="getColor" v-on:colorToAllBg="getColorBg" :textBg="clickSkin" :host="host" v-if="isShow"
              v-on:childIsShow1="childShow1" v-on:childIsShow2="childShow2" :picBg="bgSkin" :skin="skin"
              v-on:colorToAllBgPic="getColorBgPic" v-on:oldSkin="oldSkin"></skin>
        <div class="banquan">
            <div>
